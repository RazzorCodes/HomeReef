...
# ── Build ─────────────────────────────────────────────────────────────────────
echo "==================================="
echo " Building - HomeReef (Transcode)"
...
podman build \
    ...
    -t "homereef-transflux:${NEW_VERSION}" \
    -t "homereef-transflux:latest" \
    -f containerfile/homereef-transflux \
    app

echo "Done: homereef-transflux:${NEW_VERSION} (also tagged :latest)"
